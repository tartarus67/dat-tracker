...
export const DAT_COMPANIES: DATCompany[] = [
  { company: "Forward Industries", ticker: "FWDI", category: "Majors", datAsset: "SOL", cryptoYahooSymbol: "SOL-USD", holdings: 0, previousTicker: "FORD" },
  ...
  { company: "Microstrategy", ticker: "MSTR", category: "Majors", datAsset: "BTC", cryptoYahooSymbol: "BTC-USD", holdings: 641692, previousCompany: "Strategy (MicroStrategy)" },
  ...
  { company: "MARA Holdings, Inc.", ticker: "MARA", category: "Majors", datAsset: "BTC", cryptoYahooSymbol: "BTC-USD", holdings: 53250, previousCompany: "MARA Holdings" },
  ...
  { company: "Hyperscale Data Inc", ticker: "GPUS", category: "Alts", datAsset: "BTC", cryptoYahooSymbol: "BTC-USD", holdings: 0, previousAsset: "XRP" },
  { company: "IP Strategy", ticker: "IPST", category: "Alts", datAsset: "DATA", cryptoYahooSymbol: "DATA-USD", holdings: 0, previousAsset: "IP" },
  ...
  { company: "AlphaTON Capital Corp", ticker: "ATON", category: "Alts", datAsset: "TON", cryptoYahooSymbol: "TON11419-USD", holdings: 0, previousCompany: "AlphaTON Capital" },
  { company: "Zero Stack", ticker: "ZSTK", category: "Alts", datAsset: "0G", cryptoYahooSymbol: "0G-USD", holdings: 122538335 },
  { company: "CleanSpark Inc.", ticker: "CLSK", category: "Majors", datAsset: "BTC", cryptoYahooSymbol: "BTC-USD", holdings: 13011, previousCompany: "CleanSpark" },
];
